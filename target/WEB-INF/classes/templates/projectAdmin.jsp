...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="card">
                ...
                <table id="tableProject" class="table table-bordered table-striped table-hover text-center">
                    <thead>
                        <tr>
                            <th>Mã dự án</th>
                            <th>Hành Động</th>
                            <th>Tên dự án</th>
                            <th>Địa chỉ</th>
                            <th class="description">Giới thiệu</th>
                            <th>Người đăng</th>
                            <th>Ngày đăng</th>
                            <th>Ngày cập nhật</th>
                            <th>Lượt xem</th>
    ...
    <!-- The Modal -->
    <div class="modal " id="modalDetailProject">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Chi tiêt dự án</h4>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" id="inpTitle" placeholder="Đang cập nhật" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <select id="sltProvince" class="form-control" disabled>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input class="form-control" id="inpPrice" placeholder="Đang cập nhật" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label">Phòng ngủ</label>
                        <div class="col">
                            <input type="number" class="form-control" id="inpBed" placeholder="Đang cập nhật" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label">Phòng tắm</label>
                        <div class="col">
                            <input type="number" class="form-control" id="inpBath" placeholder="Đang cập nhật" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="row d-flex justify-content-around">
                        ...
                        <button id="btnFeatured" class="btn btn-primary col-auto">Nổi Bật</button>
                        <button id="btnUnFeatured" class="btn btn-warning col-auto">Bỏ Nổi Bật</button>
                        <button class="btn btn-danger col-auto" data-dismiss="modal">Đóng</button>
                    </div>
                    <hr>
                    <div class="cardProjectSameCustomer">
                        <div class="card-header">
                            <h3 class="card-title">Danh sách dự án cùng người đăng</h3>
                        </div>
                        <table id="tableProjectSameCustomer"
    ...
    <div class="modal " id="modalConfirmFeatured">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Xác nhận nổi bật</h5>
                </div>
                <div class="modal-body">
                    <p>Bạn có chắc muốn xét dự án vào mục nổi bật.</p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                    <button class="btn btn-primary" id="btnConfirmFeatured">Nổi bật</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal " id="modalConfirmUnFeatured">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Xác nhận bỏ nổi bật</h5>
                </div>
                <div class="modal-body">
                    <p>Bạn có chắc muốn xóa dự án khỏi mục nổi bật.</p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                    <button class="btn btn-primary" id="btnConfirmUnFeatured">Bỏ nổi bật</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal " id="modalConfirmApprove">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p>Bạn có chắc muốn xét duyệt dự án.</p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                    <button class="btn btn-primary" id="btnConfirmApprove">Duyệt</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal " id="modalConfirmUnApprove">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Xác nhận bỏ Duyệt</h5>
                </div>
                <div class="modal-body">
                    <p>Bạn có chắc muốn bỏ duyệt dự án. Dự án sẽ không được hiển thị với người dùng trừ người đăng</p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                    <button class="btn btn-primary" id="btnConfirmUnApprove">Bỏ Duyệt</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type='text/javascript' src="/scripts/projectAdmin.js"></script>
