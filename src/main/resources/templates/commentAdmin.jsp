...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="card">
                ...
                <table id="tableComment" class="table table-bordered table-striped table-hover text-center">
                    <thead>
                        <tr>
                            <th>Mã Bình Luận</th>
                            <th>Hành Động</th>
    ...
    <!-- The Modal -->
    <div class="modal " id="modalDetailComment">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Chi tiêt Bình Luận</h4>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <textarea class="form-control" rows="4" cols="50" id="inpContent" readonly></textarea>
                        </div>
                    </div>
    ...
    <script type='text/javascript' src="/scripts/commentAdmin.js"></script>
